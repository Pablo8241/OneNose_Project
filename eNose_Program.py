...
def program_init():
    ...
    GPIO.setup(27, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)  # Shutdown trigger
    GPIO.setup(17, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)  # Normal exit
    ...
    GPIO.add_event_detect(17, GPIO.RISING, callback=gpio_callback, bouncetime=300)
